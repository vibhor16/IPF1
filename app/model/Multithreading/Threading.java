...
//	 	gfcrObject=new GetFileCountInAllRepos(clientObject);
...
//			ProgressBar.FileCountRepoThread_lck=1;
...
//			ProgressBar.FileCountRepoThread_lck=0;
	}
...
class UtilityThread implements Runnable {
	...
	public void run() {
		...
		System.out.println("[INFO]\t<NEW Thread -> "+t.getName()+">");
	  	...
	  	// System.out.println(Utility.fileNameToPkgName);
		System.out.println("[INFO]\t<TERMINATED Thread -> "+t.getName()+">");
